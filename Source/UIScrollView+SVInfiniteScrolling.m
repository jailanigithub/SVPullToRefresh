...
- (void)scrollViewDidScroll:(CGPoint)contentOffset {
    if(self.state != SVInfiniteScrollingStateLoading && self.enabled) {
        ...
        /*
         Modified for table view scroll down to refresh
         Now refresh action called when 75% of results loaded
         */
        scrollOffsetThreshold = scrollOffsetThreshold - (scrollOffsetThreshold / 4);
